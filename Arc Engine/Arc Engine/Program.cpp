...
const EventType Arc::Program::EVENT_UPDATE_START = "updateStart";
const EventType Arc::Program::EVENT_UPDATE       = "update";
const EventType Arc::Program::EVENT_UPDATE_END   = "updateEnd";
const EventType Arc::Program::EVENT_RENDER_START = "renderStart";
const EventType Arc::Program::EVENT_RENDER       = "render";
const EventType Arc::Program::EVENT_RENDER_END   = "renderEnd";
const EventType Arc::Program::EVENT_EXIT         = "exit";
